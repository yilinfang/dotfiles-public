...
if command -v codex &>/dev/null; then
	...
	# safe_alias cm 'codex --yolo -c model=gpt-5.6-sol -c model_reasoning_effort=high -c plan_mode_reasoning_effort=medium'
	# safe_alias ch 'codex --yolo -c model=gpt-5.6-sol -c model_reasoning_effort=xhigh -c plan_mode_reasoning_effort=xhigh'
	safe_alias cq 'codex --approve-for-me -c model=gpt-5.6-luna -c model_reasoning_effort=max'
fi
